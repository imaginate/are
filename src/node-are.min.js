...
f.call(a)},doc:function(a){return c.obj(a)&&9===a.nodeType},elem:function(a){return c.obj(a)&&1===a.nodeType}},d=/^(?:any|null|undefined|empty)$|^(?:string|number|boolean|object|function|regexp|array|element|document|str|num|bool|obj|func|regex|arr|elem|doc)(?:s|map)?$/,n=/^(?:string|number|boolean|function|undefined|str|num|bool|func)$/,p=/^(?:string|number|boolean|undefined|object|function|regexp|array|element|document)s$/,t=/^(?:string|number|boolean|undefined|object|function|regexp|array|element|document)map$/,
x=/\!/,y=/\?/,r=/\=|undefined/,A=/\*|any/,z=/[^a-z\|]/g,u={str:"string",num:"number",bool:"boolean",obj:"object",func:"function",regex:"regexp",arr:"array",elem:"element",doc:"document",strs:"strings",nums:"numbers",bools:"booleans",objs:"objects",funcs:"functions",regexs:"regexps",arrs:"arrays",elems:"elements",docs:"documents",strmap:"stringmap",nummap:"numbermap",boolmap:"booleanmap",objmap:"objectmap",funcmap:"functionmap",regexmap:"regexpmap",arrmap:"arraymap",elemmap:"elementmap",docmap:"documentmap"},
w={_string:c.str,_number:c.num,_boolean:c.bool,_object:c.obj,_function:c.func,_undefined:c.undefined,_regexp:c.regex,_array:c.arr,_document:c.doc,_element:c.elem,_null:function(){return!1},_empty:function(a){if(!a)return!0;if(c.arr(a)||c.func(a))return!a.length;if(!c.obj(a))return!1;for(var g in a)if(a.hasOwnProperty(g))return!1;return!0}};return function(k,m){var h;if(!c.str(k))throw new TypeError("An is(type, val) call received a non-string type param");h=k.toLowerCase().replace(z,"").split("|");
var e;for(e=h.length;e--;)if(!d.test(h[e]))throw Error("An is(type, val) call received an invalid data type within the type param; invalid type => "+h[e]);if(A.test(k))return 1<k.length&&console.log("Confusing is() Syntax: an asterisk should not be used with other data types as the check will pass regardless of the value's type"),!0;if(c.undefined(m)&&r.test(k))return!0;if(e=c["null"](m))e=y.test(k)?!x.test(k):x.test(k);if(e)return!x.test(k)&&y.test(k);if(c["null"](m))a:{for(e=h.length;e--;)if(!n.test(h[e])){h=
!0;break a}h=!1}else a:{var l,f;for(e=h.length;e--;){l=h[e];l=u.hasOwnProperty(l)?u[l]:l;f=p.test(l)?a:null;f=!f&&t.test(l)?b:f;if(!f&&!w.hasOwnProperty("_"+l))throw Error("Failed is() Call: the private helper, forEachCheckType, encountered a missing type value property in the checks hash map; missing prop => "+l);if(f?f(m,l):w["_"+l](m)){h=!0;break a}}h=!1}return h}}();a["null"]=function(a){return null===a};a.undefined=function(a){return"undefined"===typeof a};a["boolean"]=function(a){return"boolean"===
typeof a};a.bool=a["boolean"];a.string=function(a,b){return(!1!==b||!!a)&&"string"===typeof a};a.str=a.string;a._string=function(b){return a.string(b,!1)};a._str=a._string;a.number=function(a,b){return(!1!==b||!!a)&&"number"===typeof a};a.num=a.number;a._number=function(b){return a.number(b,!1)};a._num=a._number;a.object=function(a){return!!a&&"object"===typeof a};a.obj=a.object;a.func=function(a){return!!a&&"function"===typeof a};try{a["function"]=a.func}catch(p){console.log("Your JS engine does not support is.function(). Use is.func() instead.")}a.array=
function(b){return a.obj(b)&&"[object Array]"===f.call(b)};a.arr=a.array;a.regexp=function(b){return a.obj(b)&&"[object RegExp]"===f.call(b)};a.regex=a.regexp;a.document=function(b){return a.obj(b)&&9===b.nodeType};a.doc=a.document;a.element=function(b){return a.obj(b)&&1===b.nodeType};a.elem=a.element;b=function(){function a(b,g){var d,h;if(!c.arr(b))return!1;g=g.slice(0,-1);if(!u.hasOwnProperty("_"+g))throw Error("Failed is() Call: the private helper, checkArrayVals, encountered a missing type value property in the checks hash map; missing prop => "+
g);h=u["_"+g];for(d=b.length;d--;)if(h(b[d]))return!1;return!0}function b(a,g){var d,h;if(!c.obj(a))return!1;g=g.slice(0,-3);if(!u.hasOwnProperty("_"+g))throw Error("Failed is() Call: the private helper, checkMapVals, encountered a missing type value property in the checks hash map; missing prop => "+g);h=u["_"+g];for(d in a)if(a.hasOwnProperty(d)&&!h(a[d]))return!1;return!0}var c={"null":function(a){return null===a},undefined:function(a){return"undefined"===typeof a},bool:function(a){return"boolean"===
typeof a},str:function(a){return"string"===typeof a},num:function(a){return"number"===typeof a},obj:function(a){return!!a&&"object"===typeof a},func:function(a){return!!a&&"function"===typeof a},arr:function(a){return c.obj(a)&&"[object Array]"===f.call(a)},regex:function(a){return c.obj(a)&&"[object RegExp]"===f.call(a)},doc:function(a){return c.obj(a)&&9===a.nodeType},elem:function(a){return c.obj(a)&&1===a.nodeType}},d=/^(?:any|null|undefined)$|^empty(?:array|map)?$|^(?:string|number|boolean|object|function|regexp|array|element|document|str|num|bool|obj|func|regex|arr|elem|doc)(?:s|map)?$/,
