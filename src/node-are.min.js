...
t&&p(self);p(m);u&&a&&(module.exports===exports?module.exports=n:p(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return n})})(this,function(m){function d(f,b){var e,c;b=1<b.length?v.call(b,0):b[0];if(!a.array(b))throw Error("An are."+f+"(vals) call did not receive multiple vals to evaluate");e=a[f];for(c=b.length;c--;)if(!e(b[c]))return!1;return!0}function k(a){return g.quesMark(a)?!g.exPoint(a):g.exPoint(a)}function l(a){return!g.exPoint(a)&&g.quesMark(a)}
function p(a,b){var e,c,d;for(e=b.length;e--;){c=b[e];c=w.hasOwnProperty(c)?w[c]:c;d=(d=g.arrays(c)&&n)||g.maps(c)&&u;if(!d&&!q.hasOwnProperty("_"+c))throw Error("Failed is/are Helper, _checkEachType(), Call: missing type check in _mainChecks hash map; missing type => "+c);if(d?d(a,c):q["_"+c](a))return!0}return!1}function n(f,b){var e,c;if(!a.arr(f))return!1;b=b.slice(0,-1);if(!q.hasOwnProperty("_"+b))throw Error("Failed is/are Helper, _checkArrayVals(), Call: missing type check in _mainChecks hash map; missing type => "+
b);c=q["_"+b];for(e=f.length;e--;)if(!c(f[e]))return!1;return!0}function u(f,b){var e,c;if(!a.obj(f))return!1;b=b.slice(0,-3);if(!q.hasOwnProperty("_"+b))throw Error("Failed is/are Helper, _checkMapVals(), Call: missing type check in _mainChecks hash map; missing type => "+b);c=q["_"+b];for(e in f)if(f.hasOwnProperty(e)&&!c(f[e]))return!1;return!0}function a(f,b){var e,c;if(!a._str(f))throw new TypeError("An is(type, val) call received a non-string type param");e=f.toLowerCase().replace(h.charBloat,
"").split("|");for(c=e.length;c--;)if(!g.allTypes(e[c]))throw Error("An is(type, val) call received an invalid data type within the type param; invalid type => "+e[c]);if(g.any(f))return 1<f.length&&r&&console.log("Confusing is() Syntax: an asterisk should not be used with other data types as the check will pass regardless of the value's type"),!0;if(a.undefined(b)&&g.undefined(f))return!0;if(a["null"](b)&&k(f))return l(f);if(a["null"](b))a:{for(c=e.length;c--;)if(!g.nonNull(e[c])){e=!0;break a}e=
!1}else e=p(b,e);return e}function b(f){var b,e,c;if(!a._str(f))throw new TypeError("An are(type, vals) call received a non-string type param");b=f.toLowerCase().replace(h.charBloat,"").split("|");for(c=b.length;c--;)if(!g.allTypes(b[c]))throw Error("An are(type, vals) call received an invalid data type within the type param; invalid type => "+b[c]);e=2<arguments.length?v.call(arguments,1):arguments[1];if(!a.arr(e))throw new TypeError("An are(type, vals) call did not receive multiple vals to evaluate");
if(g.any(f))return 1<f.length&&r&&console.log("Confusing are() Syntax: an asterisk should not be used with other data types as the check will pass regardless of the value's type"),!0;g.undefined(f)&&b.push("undefined");for(k(f)&&l(f)&&b.push("null");c--;)if(!p(e[c],b))return!1;return!0}var r="object"===typeof console&&"function"===typeof console.log,t=Object.prototype.toString,v=Array.prototype.slice;a["null"]=function(a){return null===a};a.nil=a["null"];a.undefined=function(a){return"undefined"===
...
arguments)};b.regex=b.regexp;b.document=function(){return d("document",arguments)};b.doc=b.document;b.element=function(){return d("element",arguments)};b.elem=b.element;b.empty=function(){return d("empty",arguments)};var x=require("fs");a.buffer=function(a){return Buffer.isBuffer(a)};a.buff=a.buffer;a.directory=function(b){var d;if(!a._string(b))return!1;try{d=x.statSync(b).isDirectory()}catch(e){d=!1}finally{return d}};a.dir=a.directory;a.directories=function(b,d){var e,c;if(!a.array(b))return!1;
a._string(d)&&d.replace(/([^\/]$)/,"$1/");e=a.directory;for(c=b.length;c--;)if(!e(b[c]))return!1;return!0};a.directorys=a.directories;a.dirs=a.directories;a.file=function(b){var d;if(!a._string(b))return!1;try{d=x.statSync(b).isFile()}catch(e){d=!1}finally{return d}};a.files=function(b,d){var e,c;if(!a.array(b))return!1;a._string(d)&&d.replace(/([^\/]$)/,"$1/");e=a.file;for(c=b.length;c--;)if(!e(b[c]))return!1;return!0};b.buffer=function(){return d("buffer",arguments)};b.buff=b.buffer;b.directory=
