...
f.call(a)},doc:function(a){return c.obj(a)&&9===a.nodeType},elem:function(a){return c.obj(a)&&1===a.nodeType}},d=/^(?:any|null|undefined)$|^empty(?:array|map)?$|^(?:string|number|boolean|object|function|regexp|array|element|document|str|num|bool|obj|func|regex|arr|elem|doc)(?:s|map)?$/,n=/^(?:string|number|boolean|function|undefined)$/,p=/^(?:string|number|boolean|undefined|object|function|regexp|array|element|document)s$/,t=/^(?:string|number|boolean|undefined|object|function|regexp|array|element|document)map$/,
...
docmap:"documentmap",emptyarray:"undefineds",emptymap:"undefinedmap"},w={_string:c.str,_number:c.num,_boolean:c.bool,_object:c.obj,_function:c.func,_undefined:c.undefined,_regexp:c.regex,_array:c.arr,_document:c.doc,_element:c.elem,_null:function(){return!1},_empty:function(a){if(!a)return!0;if(c.arr(a)||c.func(a))return!a.length;if(!c.obj(a))return!1;for(var g in a)if(a.hasOwnProperty(g))return!1;return!0}};return function(k,m){var h;if(!c.str(k))throw new TypeError("An is(type, val) call received a non-string type param");
h=k.toLowerCase().replace(z,"").split("|");var e;for(e=h.length;e--;)if(!d.test(h[e]))throw Error("An is(type, val) call received an invalid data type within the type param; invalid type => "+h[e]);if(A.test(k))return 1<k.length&&console.log("Confusing is() Syntax: an asterisk should not be used with other data types as the check will pass regardless of the value's type"),!0;if(c.undefined(m)&&r.test(k))return!0;if(e=c["null"](m))e=y.test(k)?!x.test(k):x.test(k);if(e)return!x.test(k)&&y.test(k);if(c["null"](m))a:{for(e=
h.length;e--;)if(!n.test(h[e])){h=!0;break a}h=!1}else a:{var l,f;for(e=h.length;e--;){l=h[e];l=u.hasOwnProperty(l)?u[l]:l;f=p.test(l)?a:null;f=!f&&t.test(l)?b:f;if(!f&&!w.hasOwnProperty("_"+l))throw Error("Failed is() Call: the private helper, forEachCheckType, encountered a missing type value property in the checks hash map; missing prop => "+l);if(f?f(m,l):w["_"+l](m)){h=!0;break a}}h=!1}return h}}();a["null"]=function(a){return null===a};a.undefined=function(a){return"undefined"===typeof a};a["boolean"]=
