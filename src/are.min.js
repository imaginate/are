...
(function(h,d){function g(a,b){return"object"===a||!b&&"function"===a}function f(a,b){return(a=a&&b&&a.nodeType?!1:a)&&!b&&a.Object!==Object?!1:!!a}function n(a){a.is=k.is;a.Is=k.Is;a.are=k.are;a.Are=k.Are;return!0}var k=d(),q=g(typeof exports)&&f(exports,!0),a=g(typeof module)&&f(module,!0),b=g(typeof global,!0)&&f(global),r=g(typeof window)&&f(window),t=g(typeof self)&&f(self),u=g(typeof h)&&f(h);h=q&&a&&b?global:r&&window!==(h&&h.window)?window:t?self:u?h:Function("return this")();r&&n(window);
t&&n(self);n(h);q&&a&&(module.exports===exports?module.exports=k:n(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return k})})(this,function(h){function d(m,b){var c,e;b=1<b.length?u.call(b,0):b[0];if(!a.arr(b))throw Error("An are."+m+"(vals) call did not receive multiple vals to evaluate");c=a[m];for(e=b.length;e--;)if(!c(b[e]))return!1;return!0}function g(a,b,c){for(var e in b)b.hasOwnProperty(e)&&f(a,e,b[e],c)}function f(m,b,c,e){c=f.hasOwnProperty(m)?
f[m](c):c;e=!1!==e;v["_"+b]=function(m,b){b=a.bool(b)?b:e;return a.nil(m)?b:c(m)}}function n(a,b,c){var e;for(e=a.length;e--;)if(v[a[e]](b,c))return!0;return!1}function k(a){var b,c,e;b=a.toLowerCase().replace(l.all,"").split("|");for(e=b.length;e--;){c="_"+b[e];c=w.hasOwnProperty(c)?"_"+w[c]:c;if(!v.hasOwnProperty(c))return c;b[e]=c}l["="](a)&&b.push("_undefined");return b}function q(a){return(l["?"](a)?l["!"](a):!l["!"](a))?h:!l["!"](a)&&l["?"](a)}function a(b,p){var c,e;if(!a._str(b))throw new TypeError("An is(typeStr, val) call received a non-string typeStr param");
if(l["*"](b))return"*"!==b&&"any"!==b&&r&&console.log("Confusing is() Syntax: an asterisk should not be used with other data types as the check will pass regardless of the value's type"),!0;c=k(b);if(a.str(c))throw Error("Invalid is(typeStr, val) Call: invalid type in the typeStr param; invalid type => "+c);e=q(b);return n(c,p,e)}function b(b,p){var c,e;if(!a._str(b))throw new TypeError("An are(typeStr, vals) call received a non-string typeStr param");p=2<arguments.length?u.call(arguments,1):p;if(!a.arr(p))throw new TypeError("An are(typeStr, vals) call did not receive multiple vals to evaluate");
if(l["*"](b))return"*"!==b&&"any"!==b&&r&&console.log("Confusing are() Syntax: an asterisk should not be used with other data types as the check will pass regardless of the value's type"),!0;c=k(b);if(a.str(c))throw Error("Invalid are(typeStr, val) Call: invalid type in the typeStr param; invalid type => "+c);e=q(b);a:{var d=p,f;for(f=d.length;f--;)if(!n(c,d[f],e)){c=!1;break a}c=!0}return c}var r="object"===typeof console&&"function"===typeof console.log,t=Object.prototype.toString,u=Array.prototype.slice;
