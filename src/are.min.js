...
(function(c,q){function a(a,d){return"object"===a||!d&&"function"===a}function l(a,d){return(a=a&&d&&a.nodeType?!1:a)&&!d&&a.Object!==Object?!1:!!a}function b(a){a.is=d.is;a.Is=d.Is;a.are=d.are;a.Are=d.Are;return!0}var d=q(),C=a(typeof exports)&&l(exports,!0),e=a(typeof module)&&l(module,!0),z=a(typeof global,!0)&&l(global),u=a(typeof window)&&l(window),v=a(typeof self)&&l(self),x=a(typeof c)&&l(c);c=C&&e&&z?global:u&&window!==(c&&c.window)?window:v?self:x?c:Function("return this")();u&&b(window);
v&&b(self);b(c);C&&e&&(module.exports===exports?(module.exports=d,b(module.exports)):b(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return d})})(this,function(){var c=Object.prototype.toString,q=Array.prototype.slice,a=function(){function a(h,d){var b,f;if(!e.arr(h))return!1;d=d.slice(0,-1);if(!w.hasOwnProperty("_"+d))throw Error("Failed is() Call: the private helper, checkArrayVals, encountered a missing type value property in the checks hash map; missing prop => "+
d);f=w["_"+d];for(b=h.length;b--;)if(!f(h[b]))return!1;return!0}function b(a,d){var g,f;if(!e.obj(a))return!1;d=d.slice(0,-3);if(!w.hasOwnProperty("_"+d))throw Error("Failed is() Call: the private helper, checkMapVals, encountered a missing type value property in the checks hash map; missing prop => "+d);f=w["_"+d];for(g in a)if(a.hasOwnProperty(g)&&!f(a[g]))return!1;return!0}var e={"null":function(a){return null===a},undefined:function(a){return"undefined"===typeof a},bool:function(a){return"boolean"===
...
if(f=e["null"](k))f=q.test(h)?!t.test(h):t.test(h);if(f)return!t.test(h)&&q.test(h);if(e["null"](k))a:{for(f=g.length;f--;)if(!u.test(g[f])){g=!0;break a}g=!1}else a:{var c,m;for(f=g.length;f--;){c=g[f];c=p.hasOwnProperty(c)?p[c]:c;m=v.test(c)?a:null;m=!m&&l.test(c)?b:m;if(!m&&!w.hasOwnProperty("_"+c))throw Error("Failed is() Call: the private helper, forEachCheckType, encountered a missing type value property in the checks hash map; missing prop => "+c);if(m?m(k,c):w["_"+c](k)){g=!0;break a}}g=!1}return g}}();
...
function(b){return a.obj(b)&&"[object Array]"===c.call(b)};a.arr=a.array;a.regexp=function(b){return a.obj(b)&&"[object RegExp]"===c.call(b)};a.regex=a.regexp;a.document=function(b){return a.obj(b)&&9===obj.nodeType};a.doc=a.document;a.element=function(b){return a.obj(b)&&1===obj.nodeType};a.elem=a.element;var b=function(){function a(b,d){var c,g;if(!e.arr(b))return!1;d=d.slice(0,-1);if(!p.hasOwnProperty("_"+d))throw Error("Failed is() Call: the private helper, checkArrayVals, encountered a missing type value property in the checks hash map; missing prop => "+
d);g=p["_"+d];for(c=b.length;c--;)if(g(b[c]))return!1;return!0}function b(a,d){var c,g;if(!e.obj(a))return!1;d=d.slice(0,-3);if(!p.hasOwnProperty("_"+d))throw Error("Failed is() Call: the private helper, checkMapVals, encountered a missing type value property in the checks hash map; missing prop => "+d);g=p["_"+d];for(c in a)if(a.hasOwnProperty(c)&&!g(a[c]))return!1;return!0}var e={"null":function(a){return null===a},undefined:function(a){return"undefined"===typeof a},bool:function(a){return"boolean"===
...
!1}if(!f)return!1}return!0}}();(function(){function d(b,c){c=1<c.length?q.call(c,0):c[0];if(!a.arr(c))throw Error("An are."+b+"(vals) call did not receive multiple vals to evaluate");return c}function c(a,b){var d;for(d=b.length;d--;)if(!a(b[d]))return!1;return!0}b["null"]=function(){return c(a["null"],d("null",arguments))};b.undefined=function(){return c(a.undefined,d("undefined",arguments))};b["boolean"]=function(){return c(a["boolean"],d("boolean",arguments))};b.bool=b["boolean"];b.string=function(){return c(a.string,
d("string",arguments))};b.str=b.string;b.number=function(){return c(a.number,d("number",arguments))};b.num=b.number;b.object=function(){return c(a.object,d("object",arguments))};b.obj=b.object;b.func=function(){return c(a.func,d("function",arguments))};try{b["function"]=b.func}catch(e){console.log("Your JS engine does not support are.function(). Use are.func() instead.")}b.array=function(){return c(a.array,d("array",arguments))};b.arr=b.array;b.regexp=function(){return c(a.regexp,d("regexp",arguments))};
b.regex=b.regexp;b.document=function(){return c(a.document,d("document",arguments))};b.doc=b.document;b.element=function(){return c(a.element,d("element",arguments))};b.elem=b.element})();return{is:a,Is:a,are:b,Are:b}});
