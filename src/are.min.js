...
t&&p(self);p(m);u&&a&&(module.exports===exports?module.exports=n:p(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return n})})(this,function(m){function c(g,b){var e,d;b=1<b.length?v.call(b,0):b[0];if(!a.array(b))throw Error("An are."+g+"(vals) call did not receive multiple vals to evaluate");e=a[g];for(d=b.length;d--;)if(!e(b[d]))return!1;return!0}function k(a){return f.quesMark(a)?!f.exPoint(a):f.exPoint(a)}function l(a){return!f.exPoint(a)&&f.quesMark(a)}
function p(a,b){var e,d,c;for(e=b.length;e--;){d=b[e];d=w.hasOwnProperty(d)?w[d]:d;c=f.arrays(d)&&n;c=!c&&f.maps(d)&&u;if(!c&&!q.hasOwnProperty("_"+d))throw Error("Failed is/are Helper, _checkEachType(), Call: missing type check in _mainChecks hash map; missing type => "+d);if(c?c(a,d):q["_"+d](a))return!0}return!1}function n(g,b){var e,d;if(!a.arr(g))return!1;b=b.slice(0,-1);if(!q.hasOwnProperty("_"+b))throw Error("Failed is/are Helper, _checkArrayVals(), Call: missing type check in _mainChecks hash map; missing type => "+
b);d=q["_"+b];for(e=g.length;e--;)if(!d(g[e]))return!1;return!0}function u(g,b){var e,d;if(!a.obj(g))return!1;b=b.slice(0,-3);if(!q.hasOwnProperty("_"+b))throw Error("Failed is/are Helper, _checkMapVals(), Call: missing type check in _mainChecks hash map; missing type => "+b);d=q["_"+b];for(e in g)if(g.hasOwnProperty(e)&&!d(g[e]))return!1;return!0}function a(b,c){var e,d;if(!a._str(b))throw new TypeError("An is(type, val) call received a non-string type param");e=b.toLowerCase().replace(h.charBloat,
"").split("|");for(d=e.length;d--;)if(!f.allTypes(e[d]))throw Error("An is(type, val) call received an invalid data type within the type param; invalid type => "+e[d]);if(f.any(b))return 1<b.length&&r&&console.log("Confusing is() Syntax: an asterisk should not be used with other data types as the check will pass regardless of the value's type"),!0;if(a.undefined(c)&&f.undefined(b))return!0;if(a["null"](c)&&k(b))return l(b);if(a["null"](c))a:{for(d=e.length;d--;)if(!f.nonNull(e[d])){e=!0;break a}e=
!1}else e=p(c,e);return e}function b(b){var c,e,d;if(!a._str(b))throw new TypeError("An are(type, vals) call received a non-string type param");c=b.toLowerCase().replace(h.charBloat,"").split("|");for(d=c.length;d--;)if(!f.allTypes(c[d]))throw Error("An are(type, vals) call received an invalid data type within the type param; invalid type => "+c[d]);e=2<arguments.length?v.call(arguments,1):arguments[1];if(!a.arr(e))throw new TypeError("An are(type, vals) call did not receive multiple vals to evaluate");
if(f.any(b))return 1<b.length&&r&&console.log("Confusing are() Syntax: an asterisk should not be used with other data types as the check will pass regardless of the value's type"),!0;f.undefined(b)&&c.push("undefined");for(k(b)&&l(b)&&c.push("null");d--;)if(!p(e[d],c))return!1;return!0}var r="object"===typeof console&&"function"===typeof console.log,t=Object.prototype.toString,v=Array.prototype.slice;a["null"]=function(a){return null===a};a.nil=a["null"];a.undefined=function(a){return"undefined"===
