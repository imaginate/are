...
var refs = {
  ...
  arrays: {
    ...
    err:   [ [ new Error(), new Error() ], [ new Error(), new Error() ] ],
  ...
  maps: {
    ...
    date:  [ { a:new Date(),b:new Date() }, { a:new Date(),b:new Date() } ],
    err:   [ { a:new Error(),b:new Error() }, { a:new Error(),b:new Error() } ],
